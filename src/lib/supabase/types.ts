...
//   mapping_fixed: boolean (nullable, default: true)
// Table: meetings
//   id: uuid (not null, default: gen_random_uuid())
//   lead_id: uuid (nullable)
...
// Table: leads
//   CREATE INDEX leads_cnpj_idx ON public.leads USING btree (cnpj)
//   CREATE INDEX leads_company_idx ON public.leads USING btree (company)
...
//   CREATE INDEX idx_opportunities_service ON public.opportunities USING btree (service)
